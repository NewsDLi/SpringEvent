...
import com.newsdlee.service.impl.SendEmailEventServiceImpl;
...
public class SendEmailListener implements ApplicationListener<SendEmailEvent>{
	...
	@Autowired
	private SendEmailEventServiceImpl sendEmailEventServiceImpl;
	
	@Override
	public void onApplicationEvent(SendEmailEvent event) {
		sendEmailEventServiceImpl.doAction(event.getParams());
	}
